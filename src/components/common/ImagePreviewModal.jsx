...
export default function ImagePreviewModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      />
      <div
        className="relative bg-white rounded-lg shadow-xl max-w-4xl w-full mx-2 sm:mx-4 overflow-hidden border border-gray-200"
        dir="rtl"
      >
        <div className="flex items-center justify-between px-4 py-3 border-b border-gray-200 bg-gray-50">
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={onClose}
              className="px-3 py-1.5 text-xs md:text-sm rounded border border-gray-300 text-gray-700 hover:bg-gray-100"
            >
              إغلاق
            </button>
          </div>
