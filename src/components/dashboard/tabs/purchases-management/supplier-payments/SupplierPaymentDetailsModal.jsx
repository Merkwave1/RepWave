            ...
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-lg border border-blue-200">
              <div className="flex items-center justify-between flex-wrap gap-4">
                ...
                <div className="flex flex-col items-end gap-2">
                  ...
                  {payment.supplier_payments_type &&
                    getTypeBadge(payment.supplier_payments_type)}
                </div>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-900">
                    {payment.supplier_phone || "غير متوفر"}
                  </p>
                </div>
                <div>
                  <label className="block text-sm font-medium text-gray-600">
                  ...
                  <p className="text-gray-900">
                    {payment.supplier_address || "غير متوفر"}
                  </p>
                </div>
                ...
                {payment.supplier_balance !== undefined && (
                  <div>
                    ...
                    <p
                      className={`text-lg font-semibold ${parseFloat(payment.supplier_balance) >= 0 ? "text-green-600" : "text-red-600"}`}
                    >
              ...
              <div className="bg-purple-50 p-6 rounded-lg border border-purple-200">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-900 font-medium">
                      {payment.safe_balance_before
                        ? formatMoney(payment.safe_balance_before)
                        : "غير متوفر"}
                    </p>
                  </div>
                  <div>
                    ...
                    <p className="text-gray-900 font-medium">
                      {payment.safe_balance_after
                        ? formatMoney(payment.safe_balance_after)
                        : "غير متوفر"}
                    </p>
                  </div>
                </div>
              ...
              <div className="bg-indigo-50 p-6 rounded-lg border border-indigo-200">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-900 font-semibold">
                      {(
                        (parseFloat(payment.supplier_payments_amount) /
                          parseFloat(payment.purchase_order_total)) *
                        100
                      ).toFixed(1)}
                      %
                    </p>
