...
const PurchaseOrderDetailsModal = ({
  ...
  const orderTotals = useMemo(() => {
    ...
    const orderDiscount = parseFloat(
      purchaseOrder.purchase_orders_order_discount ||
        purchaseOrder.purchase_order_order_discount ||
        0,
    );
  ...
  const formattedOrderData = useMemo(() => {
    ...
    return {
      ...
      warehouse_name: getWarehouseName(
        purchaseOrder.purchase_order_warehouse_id,
      ),
      formatted_date: (() => {
        try {
      ...
      items:
        purchaseOrder.items?.map((item) => ({
          ...
          display_name:
            item.product_variant_name || item.variant_name || "غير محدد",
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-md flex items-center justify-center z-50 p-2 sm:p-6">
      <div className="bg-white rounded-2xl shadow-2xl max-w-6xl w-full max-h-[95vh] sm:max-h-[92vh] overflow-hidden border border-gray-100 mx-2 sm:mx-0">
        {/* Header */}
        <div className="flex items-center justify-between px-4 py-3 sm:px-8 sm:py-6 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-white">
          <div className="flex items-center space-x-4 rtl:space-x-reverse">
            ...
            <span
              className={`px-4 py-1.5 rounded-full text-sm font-semibold shadow-sm ${
                statusColors[formattedOrderData?.purchase_order_status] ||
          ...
          <div className="flex items-center space-x-2 rtl:space-x-reverse">
           ...
           transition-all duration-200 hover:scale-110"
            ...
            <button
              onClick={onClose}
              className="p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-lg transition print:hidden"
            >
              <FaTimes size={20} />
            </button>
          </div>
        ...
        {/* Content */}
        <div className="overflow-y-auto max-h-[calc(95vh-120px)] sm:max-h-[calc(92vh-200px)]">
          {loading && (
              ...
              <div className="bg-gray-50/70 rounded-2xl p-8 border border-gray-100 shadow-sm">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div>
                    ...
                    <p className="text-gray-900 font-medium mt-1">
                      {formattedOrderData.purchase_order_id}
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-gray-900 font-medium mt-1">
                      {formattedOrderData.supplier_name}
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-gray-900 font-medium mt-1">
                      {formattedOrderData.warehouse_name}
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-gray-900 font-medium mt-1">
                      {formattedOrderData.formatted_date}
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-xl font-bold text-green-600 mt-1">
                      {formatMoney(orderTotals.grandTotal)}
                    </p>
                  </div>
                </div>
                ...
                {formattedOrderData.purchase_order_notes && (
                  <div className="mt-6">
                    ...
                    <p className="text-gray-700 mt-2 bg-white p-4 rounded-xl border border-gray-100">
                      {formattedOrderData.purchase_order_notes}
                    </p>
                  </div>
                )}
                ...
                <div className="space-y-3">
                  <div className="flex justify-between text-gray-700">
                    ...
                    <span className="font-medium">
                      {formatMoney(orderTotals.subtotal)}
                    </span>
                  </div>
                  ...
                  {orderTotals.orderDiscount > 0 && (
                    <div className="flex justify-between text-red-600">
                      ...
                      <span className="font-medium">
                        -{formatMoney(orderTotals.orderDiscount)}
                      </span>
                    </div>
                  )}
