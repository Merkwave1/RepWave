...
function UpdateWarehouseForm({
  ...
  const handleSubmit = (e) => {
    ...
    if (
      ...
      alert(
        "يرجى ملء الحقول الإلزامية: اسم المخزن، عنوان المخزن، الشخص المسؤول، ورقم هاتف المخزن.",
      );
      return;
    }
  ...
  return (
    ...
    >
      ...
      <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4">
        ...
        <div>
          <label
            htmlFor="warehouse_representative_user_id"
            className="block text-sm font-medium text-gray-700"
          >
            الشخص المسؤول
            {formData.warehouse_type === "Van" && (
        ...
        <div>
          <label
            htmlFor="warehouse_contact_person"
            className="block text-sm font-medium text-gray-700"
          >
