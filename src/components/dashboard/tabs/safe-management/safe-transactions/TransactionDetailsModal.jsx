  ...
  return (
    <>
      ...
      >
        ...
        >
          {/* Header */}
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 px-4 py-3 sm:px-6 sm:py-4 flex justify-between items-center">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <p
                        className={`text-lg font-bold text-gray-900 ${card.valueClass || ""}`}
                      >
                        {card.value || "-"}
                      </p>
                      {card.helper && (
                      ...
                      {card.badgeClass && (
                        <span
                          className={`inline-flex items-center mt-2 px-3 py-1 rounded-full text-xs font-semibold ${card.badgeClass}`}
                        >
                          {card.value}
                        </span>
                      )}
                ...
                <div className="flex flex-col md:flex-row items-stretch gap-4">
                  <div className="flex-1 bg-white border border-red-100 rounded-xl p-4 shadow-sm">
                    ...
                    <p className="text-base font-bold text-gray-900">
                      {directionDetails.source_safe_name || "—"}
                    </p>
                    <p className="text-xs text-gray-500 mt-1">
                      {getSafeTypeLabel(directionDetails.source_safe_type)}
                    </p>
                    {directionDetails.source_rep_name &&
                      directionDetails.source_safe_type !== "company" && (
                        <p className="text-xs text-gray-400 mt-2">
                          المسؤول: {directionDetails.source_rep_name}
                        </p>
                      )}
                  </div>
                  ...
                  <div className="flex-1 bg-white border border-green-100 rounded-xl p-4 shadow-sm">
                    ...
                    <p className="text-base font-bold text-gray-900">
                      {directionDetails.destination_safe_name || "—"}
                    </p>
                    <p className="text-xs text-gray-500 mt-1">
                      {getSafeTypeLabel(directionDetails.destination_safe_type)}
                    </p>
                    {directionDetails.destination_rep_name &&
                      directionDetails.destination_safe_type !== "company" && (
                        <p className="text-xs text-gray-400 mt-2">
                          المسؤول: {directionDetails.destination_rep_name}
                        </p>
                      )}
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    {transaction?.related_transaction_id && (
                      <p className="text-[11px] text-gray-400 mt-1">
                        مرتبط بالعملية رقم {transaction.related_transaction_id}
                      </p>
                    )}
                  </div>
                </div>
              ...
              <div className="bg-white border border-gray-100 rounded-xl p-5 shadow-sm space-y-5">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      {getSafeTypeLabel(transaction?.safe_type)}
                    </p>
                  </div>
                </div>
                ...
                {transaction?.approved_by_name && (
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-400 mt-1">
                        {formatLocalDateTime(transaction?.approved_date)}
                      </p>
                    </div>
                  </div>
                )}
                ...
                {transaction?.related_transaction && !directionDetails && (
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-semibold text-gray-900">
                        {transaction.related_transaction.safe_name || "—"}
                      </p>
                      <p className="text-xs text-gray-400 mt-1">
                        {getTransactionTypeDisplay(
                          transaction.related_transaction.type,
                        )}
                      </p>
                    </div>
                  </div>
      ...
      <ConfirmActionModal
        ...
        confirmButtonText={
          confirmAction === "approve" ? "نعم، الموافقة" : "نعم، الرفض"
        }
