    ...
    <Modal isOpen={isOpen} onClose={onClose} title="تفاصيل المستخدم" dir="rtl">
      <div className="p-4 text-right">
        ...
        <div className="mt-6 flex justify-center">
          <button
            onClick={onClose}
            className="px-6 py-2 bg-[#8DD8F5] text-black rounded-md hover:bg-[#1F2937] hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-150 ease-in-out shadow-md"
          >
            إغلاق
          </button>
        </div>
